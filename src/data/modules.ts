...
export const MODULES: Module[] = [
    ...
    curriculum: [
      {
        ...
        duration: "45 min",
        lessons: [
          { name: "What is a Workforce Planning Agent?", type: "▶", dur: "12 min", free: false },
  ...
  },
  {
    ...
    curriculum: [
      {
        ...
        duration: "40 min",
        lessons: [
          { name: "How engagement surveys generate agent opportunities", type: "▶", dur: "14 min", free: false },
    ...
    prompts: [
      {
        label: "Survey Results Summarizer",
        text: "You are an HR Engagement Agent. Given survey results for {team_name} ({survey_date}): {survey_data}\n\nProduce a 1-page manager summary: top 3 strengths, top 3 concerns, most common themes (workload/leadership/growth/culture/tools), and overall sentiment score.",
      },
      {
        label: "Manager Action Plan Generator",
        text: "Based on low-scoring dimensions for {manager_name}'s team: {low_scores}\n\nGenerate a 90-day action plan with 3 specific, measurable actions per dimension. Include: what to do, cadence, accountability, and how to measure progress.",
      },
      {
        label: "Open-Text Sentiment Tagger",
        text: "Classify each survey response with sentiment (Positive/Neutral/Negative) and theme tags from [Workload, Manager Relationship, Career Growth, Team Culture, Tools, Benefits, Recognition, Communication, Work-Life Balance].\n\nResponses: {responses}\n\nOutput as JSON: response_id, sentiment, themes.",
      },
    ],
  },
  {
    ...
    curriculum: [
      {
        ...
        duration: "50 min",
        lessons: [
          { name: "Mapping skills frameworks to content libraries", type: "▶", dur: "18 min", free: false },
    ...
    prompts: [
      {
        ...
        text: "For {job_title} at {company_size} in {industry}, level {level}: create a 90-day onboarding learning path. Week 1 (orientation), Month 1 (role skills), Month 2–3 (advanced). Per item: topic, format, duration, priority (must/should/nice-to-have).",
      },
      {
        label: "Skill Gap Analyzer",
        text: "Given employee profile: {employee_data} and role competency framework for {job_title}: {framework}\n\nIdentify top 5 skill gaps by business impact. For each, recommend 2–3 resources from {lms_platform}. Output as a structured development plan table.",
      },
      {
        label: "Completion Nudge Drafter",
        text: "Draft 3 nudge messages for employees who haven't completed {training_name} (deadline: {deadline}):\n(1) First reminder — friendly\n(2) Second reminder — more urgent\n(3) Final notice — escalation tone\nUnder 80 words each, suitable for Slack or email.",
      },
    ],
  },
  {
    ...
    curriculum: [
      {
        ...
        duration: "45 min",
        lessons: [
          { name: "Understanding rating distributions", type: "▶", dur: "16 min", free: false },
    ...
    curriculum: [
      {
        ...
        duration: "35 min",
        lessons: [
          { name: "Where AI adds value in recruiting", type: "▶", dur: "12 min", free: false },
    ...
    curriculum: [
      {
        ...
        duration: "30 min",
        lessons: [
          { name: "Cross-functional dependencies: IT, payroll, facilities", type: "▶", dur: "16 min", free: false },
        ],
      },
      {
        phase: "Building the Agent",
    ...
    curriculum: [
      {
        ...
        duration: "40 min",
        lessons: [
          { name: "Policy lifecycle: creation → attestation", type: "▶", dur: "14 min", free: false },
  ...
  },
  {
    ...
    curriculum: [
      {
        ...
        duration: "50 min",
        lessons: [
          { name: "Salary survey methodology & market positioning", type: "▶", dur: "18 min", free: false },
    ...
    prompts: [
      {
        label: "Pay Band Generator",
        text: "Using market data for {job_title} at {job_level} in {location} ({survey_source}, {survey_year}): {market_data}\n\nGenerate pay band: minimum, midpoint, maximum, range spread %, compa-ratio for current employees, rationale for positioning at target {target_percentile}.",
      },
      {
        label: "Offer Flag Checker",
    ...
    curriculum: [
      {
        ...
        duration: "35 min",
        lessons: [
          { name: "Representation vs. equity vs. inclusion: what to measure", type: "▶", dur: "19 min", free: false },
        ],
      },
      {
        phase: "Building the Agent",
    ...
    curriculum: [
      {
        ...
        duration: "30 min",
        lessons: [
          { name: "Offer letter anatomy: required vs. optional elements", type: "▶", dur: "16 min", free: false },
        ],
      },
      {
        phase: "Building the Agent",
    ...
    curriculum: [
      {
        ...
        duration: "40 min",
        lessons: [
          { name: "Privilege, confidentiality & documentation guardrails", type: "▶", dur: "24 min", free: false },
        ],
      },
      {
        phase: "Building the Agent",
    ...
    curriculum: [
      {
        phase: "Foundations",
        duration: "35 min",
        lessons: [{ name: "Open enrollment cycle & life event triggers", type: "▶", dur: "19 min", free: false }],
      },
      {
        phase: "Building the Agent",
        duration: "85 min",
