...
const WORKSTREAM_META: Record<LoaWorkstreamDomain, WorkstreamDomainMeta> = {
  Payroll: { icon: Wallet },
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          {(stage === "launch" || stage === "running") && selected && (
            <ControlLaunchPanel
              scenario={selected}
              eventStreamLabel="Leave Event"
              eventCategoryLabel={
                selected.eventType === "Return / Extension"
                  ? "Return-to-Work / Extension"
                  : "Leave Request"
              }
              runButtonLabel="Run Leave / LOA Agent"
              runningLabel="Running Leave / LOA Agent…"
              onBack={goQueue}
              onRun={startRun}
          ...
          {stage === "results" && selected && (
            <ControlResultsView
              scenario={selected}
              verdictAnchorId="loa-control-verdict"
